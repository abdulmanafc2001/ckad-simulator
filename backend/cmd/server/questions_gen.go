...
func generatedQuestions() []*models.Question {
	...
	qs = append(qs, genP7StsClaims()...)
	qs = append(qs, genP7Projected()...)
	qs = append(qs, genP7AntiAffinity()...)
	qs = append(qs, genP7TopologySpread()...)
	qs = append(qs, genP7PriorityPods()...)
	qs = append(qs, genP7PDB()...)
	qs = append(qs, genP7TlsSecrets()...)
	qs = append(qs, genP7Roles()...)
	qs = append(qs, genP7RoleBindings()...)
	qs = append(qs, genP7HostPorts()...)
	qs = append(qs, genP7TrafficPolicy()...)
	qs = append(qs, genP7IndexedJobs()...)
	qs = append(qs, genP7IngressTls()...)
	qs = append(qs, genP7Seccomp()...)
	qs = append(qs, genP7NetpolCombo()...)
	qs = append(qs, genP7DeployCombo()...)
	qs = append(qs, genP7NsGovernance()...)
	qs = append(qs, genP7SidecarHardened()...)
	qs = append(qs, genP7CronFull()...)
	qs = append(qs, genP7HeadlessNamed()...)
	qs = append(qs, genP7TripleProbes()...)
	qs = append(qs, genP7EnvMix()...)
	qs = append(qs, genP7PausedRollout()...)
	qs = append(qs, genP7SvcMultiportType()...)
	qs = append(qs, genP7ProbeLifecycle()...)
	qs = append(qs, genP7FullHarden()...)
	qs = append(qs, genP7ThreeContainers()...)
	qs = append(qs, genP7IngressAnnot()...)
	qs = append(qs, genP7CmdArgsBoth()...)
	qs = append(qs, genP7SecretTypes()...)
	qs = append(qs, genP7MatchExprDeploy()...)
	qs = append(qs, genP8ManualEndpoints()...)
	qs = append(qs, genP8DefaultBackend()...)
	qs = append(qs, genP8NetpolNamespace()...)
	qs = append(qs, genP8NetpolPortRange()...)
	qs = append(qs, genP8StsPartition()...)
	qs = append(qs, genP8HpaBehavior()...)
	qs = append(qs, genP8NativeSidecar()...)
	qs = append(qs, genP8EphemeralDebug()...)
	qs = append(qs, genP8StartupGrpcProbes()...)
	qs = append(qs, genP8CronTimeZone()...)
	qs = append(qs, genP8SuspendedJobs()...)
	qs = append(qs, genP8BinaryConfigMaps()...)
	qs = append(qs, genP8ImmutableSecrets()...)
	qs = append(qs, genP8DnsConfig()...)
	qs = append(qs, genP8MultiHostIngress()...)
	qs = append(qs, genP8RoleResourceNames()...)
	qs = append(qs, genP8BlueGreenSwitch()...)
	return qs
}
